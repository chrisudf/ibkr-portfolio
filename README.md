...
卖 put 那一项是重点 —— 还没被行权的现金担保 put 也是已经承诺出去的仓位，
不算进去的上限一股没成交就能被突破。期权多头按**市值**而不是名义计入
（一张 LEAPS call 按 strike × 100 会虚报成实际投入资金的好几倍）；卖出 call
不计，它压的是上面已经算过的正股的上涨空间。

分母是**全部账户合并**的总净值，跟你在哪个账号 tab 上看无关 ——「占总资产 5%」
说的是整本账，一个标的分散在两个账号里不该读成两个安逸的半仓。注意持仓地图上
方块的**面积**仍然是当前账号的正股市值，所以小方块也可能挂超上限角标，
hover 能同时看到两个数。只卖 put、没有正股的标的根本不在地图上，看
「核心持仓与仓位上限」那张表。
